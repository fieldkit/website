			...
			<div class="section__inner">
				<div class="social-share-menu-container">
					...
					<ul class="social-share-menu">
						...
						<li class="social-share-menu-item">
							<a href="https://www.linkedin.com/shareArticle?mini=true&title=&summary=&source=&url=<?php echo urlencode(get_the_permalink()); ?>" target="_blank" title="<?php echo __('Twitter', 'rocnation'); ?>">
