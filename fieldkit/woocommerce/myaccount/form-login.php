...
<?php if (!isset($_GET['action']))  : ?>
	...
	<div class="u-column1 col-1 woocommerce-form--account-container">
		...
		<?php
			echo '<a href="' . wc_get_page_permalink( 'myaccount' ) . '?action=register"> Create an account </a>';
		?>
		</div>
	</div>
<? endif; ?>
	...
	<div class="u-column2 col-2 woocommerce-form--account-container">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					...
					<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" placeholder="Full Name" name="username" id="reg_username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
				</p>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row--password reg_password">
		...
		<div class="redirection-link">
			<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My Account','fieldkit'); ?>">Log In to Account </a>
		</div>
